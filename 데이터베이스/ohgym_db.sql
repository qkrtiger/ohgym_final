...
CREATE TABLE `gym` (
                       ...
                       `goriname` varchar(100) DEFAULT NULL,
...
SELECT m.membernum, m.mid, m.mname, m.mbirth, m.mgender,
       m.mphone, m.mnickname, m.moriname, m.msysname,
       m.tcareer, m.tlicence, m.tpr, m.toriname,
...
select gm.membernum, g.gymnum, g.gname, g.glocation, g.goriname, g.gsysname
...
SELECT m.membernum, m.mid, m.mname, m.mbirth, m.mgender,
       ...
       g.gaddservpay, g.goperation, g.goriname, g.gsysname
